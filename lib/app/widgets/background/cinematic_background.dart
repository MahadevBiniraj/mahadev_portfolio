...
class _CinematicBackgroundState extends State<CinematicBackground>
  ...
  void _updateGrainTexture(Size size) {
    // Update grain at ~15Hz instead of 60Hz.
    final seed = (_animController.value * 450).toInt(); 
...
class _MeshGradientPainter extends CustomPainter {
  ...
  void _drawGrain(Canvas canvas, Size size) {
    ...
    _grainPaint.shader = ImageShader(
      grainImage!,
      TileMode.repeated,
      TileMode.repeated,
    ...
    canvas.drawRect(Rect.fromLTWH(0, 0, size.width, size.height), _grainPaint);
  }
